...
public class DataLoader implements CommandLineRunner {
        ...
        private List<Restaurant> insertRestaurants() {
                ...
                List<Restaurant> savedRestaurants = restaurantRepository
                                .saveAll(Arrays.asList(restaurant1, restaurant2));
        ...
        private void testQueries(List<Customer> customers, List<Restaurant> restaurants, List<Product> products,
                ...
                var restaurantsByDeliveryFee = restaurantRepository
                                .findByDeliveryFeeLessThanEqual(new BigDecimal("5.00"));
                ...
                System.out.println("Top 5 restaurantes por nome: "
                                + topRestaurants.stream().map(restaurant -> restaurant.getName())
                                                .collect(Collectors.joining(", ")));
                ...
                System.out.println(
                                "Existe cliente joao@email.com: " + customerRepository.existsByEmail("joao@email.com"));
        }
